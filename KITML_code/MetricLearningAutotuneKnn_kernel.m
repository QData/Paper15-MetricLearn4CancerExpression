function A = MetricLearningAutotuneKnn_kernel(metric_learn_alg, y, X, params); 
...
for (i=1:length(gammas)),
    ...
    accs(i) = CrossValidateKNN_kernel(y, X, @(y,X) MetricLearning_kernel(metric_learn_alg, y, X, A0, params), 2, params.k);
...
params.gamma = gamma;
A = MetricLearning_kernel(metric_learn_alg, y, X, A0, params);